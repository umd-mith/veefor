...
items_source_column_mappings: dict[str, str] = {
    ...
    "Title": "title",
    "Source (Provenance)": "linked_entity_source",
    "Creation Date": "created_date",
    "Creator": "linked_entity_as_creator",
    "Interviewer": "linked_entity_interviewers",
    "Interviewee": "linked_entity_interviewees",
    "Lakeland Collection": "collection",
    "People": "linked_people",
    "Places/Organizations": "linked_places_orgs",
    "Subjects": "linked_subjects",
    "Legacy Identifier-LCHP": "legacy_idno_lchp",
    "Interview Summary": "interview_summary_attachment",
    "In Lakeland Book?": "lakeland_book",
    "Lakeland Book Chapter": "lakeland_book_chapter",
    "Lakeland Book Page #": "lakeland_book_page",
    "Description": "description",
    "Flag for Removal?": "remove",
    "Used in Lakeland Video?": "lakeland_video",
    "airtable_createdTime": "airtable_created_time",
    "airtable_id": "airtable_idno",
}
...
relationships_source_column_mappings: dict[str, str] = {
    "Name": "name",
    "Entity 1": "entity_1",
